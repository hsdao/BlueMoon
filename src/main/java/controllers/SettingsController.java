...
public class SettingsController implements Initializable {
    ...
    private static final String[] THEME_NAMES = {
            "PrimerLight (Sáng – Mặc định)",
            "NordDark (Tối – Nord)",
            "CupertinoDark (Tối – macOS Style)"
    };
    ...
    private void handleApply() {
        ...
        if (selected.startsWith("NordDark")) {
            stylesheet = new NordDark().getUserAgentStylesheet();
            themeKey   = "NordDark";
        } else if (selected.startsWith("CupertinoDark")) {
            stylesheet = new CupertinoDark().getUserAgentStylesheet();
            themeKey   = "CupertinoDark";
        } else {
    ...
    public static void applyStoredTheme() {
        ...
        String stylesheet = switch (theme) {
            case "NordDark"     -> new NordDark().getUserAgentStylesheet();
            case "CupertinoDark"-> new CupertinoDark().getUserAgentStylesheet();
